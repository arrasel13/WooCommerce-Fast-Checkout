...
<div class="wcfc-parent-wrapper">
    <ul class="wcfc-header">
        <li class="wcfc-item-1"><h2>Shopping Cart(5)</h2></li>
        <li class="wcfc-item-2">
    ...
    <ul class="wcfc-products">
        <li class="wcfc-product-list">
            <div class="wcfc-product-info">
                <img src="<?php echo WCFC_PUBLIC_ASSETS_URL . 'img/img-2.png' ?>"></img>
                <div class="wcfc-product-info-2">
                    <p>Trendy Shoes For Men</p>
                    <p>1 pair X 5</p>
                    <div class="wcfc-info-group">
                        ...
                        <input type="number" class="wcfc-class" name="wcfc-qty" value="2"></input>
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p class="wcfc-product-price">$50</p>
            </div>
        </li>
        <li class="wcfc-product-list">
            <div class="wcfc-product-info">
