<div class="wfc-cart-wrapper">
    <svg class="cart-icon" width="35" height="35" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="wfc-cart-count">5</div>
</div>